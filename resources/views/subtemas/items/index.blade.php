        ...
        <div class='max-w-xs w-full bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
            ...
            <div class='px-2 py-3'>
                <div class='w-full text-center mb-3'>
                    <img class='w-24 h-24 inline-block object-cover rounded-full' alt='CompanyIcon'
                ...
                <table class="w-full border">
                    ...
                    <tbody>
                        <tr class="border-t text-sm">
                            ...
                            <td class="p-1 pl-2 border-r">1</td>
                            <td class="p-1 text-right">42.00 <small
                                    class="font-bolder text-lg pr-2 text-gray-300">$</small></td>
                        </tr>
                        <tr class="border-t text-sm">
                            <td class="p-1 pl-2 border-r">2</td>
                            <td class="p-1 pl-2 border-r">Cerial</td>
                            <td class="p-1 pl-2 border-r">1</td>
                            <td class="p-1 text-right">10.00 <small
                                    class="font-bolder text-lg pr-2 text-gray-300">$</small></td>
                        </tr>
                        <tr class="border-t text-sm">
                            ...
                            <td class="p-1 pl-2 border-r">1</td>
                            <td class="p-1 text-right">100.00 <small
                                    class="font-bolder text-lg pr-2 text-gray-300">$</small></td>
                        </tr>
                    </tbody>
                    <thead>
                        <tr class="border-t-2 text-sm">
                            ...
                            <td class="p-1 text-right">152.00 <small
                                    class="font-bolder text-lg pr-2 text-gray-300">$</small></td>
                        </tr>
                        <tr class="border-t-2 text-sm">
                            <td class="p-2" colspan="2"></td>
                            <td class="p-2 text-right border-r">Tax</td>
                            <td class="p-1 text-right">15.20 <small
                                    class="font-bolder text-lg pr-2 text-gray-300">$</small></td>
                        </tr>
                        <tr class="border-t-2 text-sm">
                            <td class="p-2" colspan="2"></td>
