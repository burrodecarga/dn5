    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden sm:rounded-lg">
                <h1 class="font-bold text-center text-2xl text-gray-800 pt-2 bg-gray-50">Nuevo Sub-Tema</h1>
                            ...
                            <div class="sm:rounded-md sm:overflow-hidden">
                                ...
                                <div class="px-4  bg-white space-y-6 sm:p-6">
                                    ...
                                    <select name="tema_id" id=""
                                        class="w-full my-2  rounded @error('titulo')is-invalid @else border-0 @enderror">
