    ...
    <div class="py-6">
        <div class="mx-auto sm:px-6 lg:px-8 bg-red-200" style="max-width:70%">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <h1 class="text-bold text-center text-gray-800 py-2 uppercase">Crear Nuevo Item al subtema:
                    {{$subtema->titulo}}</h1>
                <hr>
                <div class="mt-0 md:mt-0">
                    <form action="{{route('items.store',$subtema->id)}}" method="POST" enctype="multipart/form-data"
                        multiple>
                        @csrf
                        @method('POST')
                        ...
                        <div class="sm:rounded-md sm:overflow-hidden">
                            <div class="px-4 py-2 bg-white space-y-6 sm:p-6">
                                ...
                                <input id="titulo" type="text" name="titulo" value="{{old('titulo', $item->titulo)}}"
                                ...
                                <div class="grid grid-rows-2 gap-2">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="checkbox" name="publicado" @if($item->publicado == 1) cheked
                                            @endif>
